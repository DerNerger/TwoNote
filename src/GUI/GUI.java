...
public class GUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonCurser.setIcon(new javax.swing.ImageIcon("pictures/curserBild.png")); // NOI18N
        ...
        buttonText.setIcon(new javax.swing.ImageIcon("pictures/textBild.png")); // NOI18N
	...
	{
		JOptionPane.showMessageDialog(jPanel1,"\""+e.getDirectoryTitle()+"\" existiert bereits.  Bitte w��hlen sie einen anderen Namen.", "Name bereits vorhanden!", JOptionPane.ERROR_MESSAGE);
	}
        refreshComboBoxBooks();
    ...
    private void buttonCreateNewChapterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCreateNewChapterActionPerformed
        try {
			...
			JOptionPane.showMessageDialog(jPanel1,"\""+e.getDirectoryTitle()+"\" existiert nicht.  Bitte w��hlen sie einen anderes.", "Verzeichnis existiert nicht!", JOptionPane.ERROR_MESSAGE);
		} catch (DirectoryAlreadyExistsException e)
    	{
    		JOptionPane.showMessageDialog(jPanel1,"\""+e.getDirectoryTitle()+"\" existiert bereits.  Bitte w��hlen sie einen anderen Namen.", "Name bereits vorhanden!", JOptionPane.ERROR_MESSAGE);
    	} catch (SQLException e)
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        ...
        {
        	JOptionPane.showMessageDialog(jPanel1, "Sie haben kein Element ausgew��hlt.", "Nichts ausgew��hlt!", JOptionPane.ERROR_MESSAGE);
        	return;
        }
    	TreePath tree = treeBookView.getSelectionPath();
        if(tree==null)
